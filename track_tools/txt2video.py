...
def txt2img(visual_path="visual_val_gt"):
    ...
    gt_json_path = 'boat_dataset/annotations/val_half.json'
    img_path = 'boat_dataset/train/'
    show_video_names = ['001_A', 
                    '002_A',
                    '003_A',
                    '004_A',
                    '005_A',        
    ...
    test_json_path = 'boat_dataset/annotations/test.json'
    test_img_path = 'boat_dataset/test/'
    test_show_video_names = ['001_B', 
                    '002_B',
                    '003_B',
                    '004_B',
                    '005_B',        
    ...
    for show_video_name in show_video_names:
        ...
        if visual_path == "visual_val_gt":
            txt_path = 'boat_dataset/train/' + show_video_name + '/gt/MOT_gt_val_half.txt'
