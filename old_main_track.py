...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', default='boat_dataset', type=str)
    ...
    # appended for track.
    parser.add_argument('--track_train_split', 
                        # default='train',
                        default='test',
                        type=str) 
    parser.add_argument('--track_eval_split', 
                        # default='val',
                        default='test',
                        type=str)
